 ...
 * @author Leona
 */
public class DoublyLinkedList3_0<T> {

    private Node<T> front;

    private Node<T> rear;

    public DoublyLinkedList3_0() {
        front = rear = null;
    }
    ...
    public DoublyLinkedList3_0<T> getEvenElements() {
        DoublyLinkedList3_0 evenList = new DoublyLinkedList3_0<>();
        Node<T> current = front;
